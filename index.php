							...
							<div class="card-body px-3 py-4-5">
								<div class="row">
									...
									<div class="col-md-8">
										...
										<?php
										$solicitudes = obtenerNumeroClientes('id');
						...
						<div class="card">
							<div class="card-body px-3 py-4-5">
								<div class="row">
									...
									<div class="col-md-8">
										<h6 class="text-muted font-semibold">Vendidos</h6>
										<?php
										$solicitudes = obtenerLotesVendidos();
										if ($solicitudes->num_rows > 0) {
											echo '<h6 class="font-extrabold mb-0">' . $solicitudes->num_rows . '</h6>';
										} else {
											// no hay tareas
						...
						<div class="card">
							<div class="card-body px-3 py-4-5">
								<div class="row">
									...
									<div class="col-md-8">
										<h6 class="text-muted font-semibold">Reservados</h6>
										<?php
										$solicitudes = obtenerLotesReservados();
										if ($solicitudes->num_rows > 0) {
											echo '<h6 class="font-extrabold mb-0">' . $solicitudes->num_rows . '</h6>';
										} else {
											// no hay tareas
