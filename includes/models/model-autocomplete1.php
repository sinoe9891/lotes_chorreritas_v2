...
if ($_POST['mi_busqueda'] != "") {
	...
	// echo $mi_busqueda;
	$estadoCuenta = $conn->query("SELECT a.fecha_pagada, b.id_ficha_compra, a.fecha_cuota, a.id_cuota_pagada, b.cuota, a.cantidad_pagada, b.total_venta, a.monto_restante, b.plazo_meses, a.fecha_vencimiento, b.fecha_primer_cuota FROM cobros a, ficha_compra b WHERE b.id_ficha_compra = '$mi_busqueda'");
	$contador = 1;
