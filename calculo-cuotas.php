...
<body>
	...
	<!-- <?php
			...
			$consultaFechaCuota = $conn->query("SELECT a.fecha_primer_cuota, b.fecha_vencimiento FROM ficha_compra a, control_credito_lote b WHERE a.id_ficha_compra = 1 AND a.id_ficha_compra = b.id_compra");
	...
	<?php
		...
		// 	$no_cuota = $i;
		// 	$insertarFechas = $conn->query("INSERT INTO control_credito_lote (id_compra, fecha_pago, fecha_vencimiento, no_cuota) VALUES ('1','$fecha_pago1', '$fecha_vencimiento', '$no_cuota')");
		// 	if ($insertarFechas) {
	...
	<table>
		...
		$estadoCuenta = $conn->query("SELECT * FROM control_credito_lote a, ficha_compra b WHERE a.id_compra = 1 and b.id_ficha_compra = a.id_compra");
		$contador = 1;
