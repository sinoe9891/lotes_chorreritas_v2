					...
					<div class="card">
						...
						<div class="card-body">
							<ul class="nav nav-tabs" id="myTab" role="tablist">
								...
								<li class="nav-item" role="presentation">
									<a class="nav-link" id="observaciones-tab" data-bs-toggle="tab" href="#observacion" role="tab" aria-controls="observaciones-tab" aria-selected="false">8.-Observaciones</a>
								</li>
							</ul>
